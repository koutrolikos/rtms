...
class BuildExecutor:
    ...
    def run_build(self, payload: BuildArtifactPayload, *, client: ServerClient, host_id: str) -> JobResult:
        return self._run_build(payload, client=client, host_id=host_id, origin_type=ArtifactOriginType.GITHUB_BUILD)

    def run_local_build_upload(
        self, payload: BuildArtifactPayload, *, client: ServerClient, host_id: str
    ) -> JobResult:
        return self._run_build(
            payload,
            client=client,
            host_id=host_id,
            origin_type=ArtifactOriginType.LOCAL_HOST_BUILD,
        )
