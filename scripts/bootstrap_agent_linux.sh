...
export RANGE_TEST_OPENOCD_SCAN_PROBES=1
export RANGE_TEST_OPENOCD_SCAN_INTERVAL_SECONDS=10
export RANGE_TEST_SIMULATE_HARDWARE=0
export RANGE_TEST_SIMULATE_CAPTURE=0
export RANGE_TEST_OPENOCD_RTT_SEARCH_ADDRESS="0x20000000"
export RANGE_TEST_OPENOCD_RTT_SEARCH_SIZE_BYTES=131072
export RANGE_TEST_OPENOCD_RTT_ID="SEGGER RTT"
export RANGE_TEST_OPENOCD_RTT_HUMAN_CHANNEL=0
export RANGE_TEST_OPENOCD_RTT_MACHINE_CHANNEL=1
export RANGE_TEST_OPENOCD_RTT_POLLING_INTERVAL_MS=10
export RANGE_TEST_OPENOCD_RTT_STARTUP_TIMEOUT_SECONDS=15
ENVVARS
