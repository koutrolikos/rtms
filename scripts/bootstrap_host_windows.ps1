...
`$env:RTMS_OPENOCD_SCAN_PROBES = '1'
`$env:RTMS_OPENOCD_SCAN_INTERVAL_SECONDS = '10'
`$env:RTMS_SIMULATE_HARDWARE = '0'
`$env:RTMS_SIMULATE_CAPTURE = '0'
`$env:RTMS_OPENOCD_RTT_SEARCH_ADDRESS = '0x20000000'
`$env:RTMS_OPENOCD_RTT_SEARCH_SIZE_BYTES = '131072'
`$env:RTMS_OPENOCD_RTT_ID = 'SEGGER RTT'
`$env:RTMS_OPENOCD_RTT_HUMAN_CHANNEL = '0'
`$env:RTMS_OPENOCD_RTT_MACHINE_CHANNEL = '1'
...
Write-Host '  . .\.rtms-env.ps1'
Write-Host '  .\.venv\Scripts\rtms-host.exe run'
